...
void main() {
  ...
  testWidgets('english displays action details, without sensor, with time range',
          (WidgetTester tester) async {
        MockApi mockApi = MockApi();
        SensorDriverAction action = SensorDriverAction(
          id: 1,
  ...
  testWidgets('english displays action details, with sensor and only start time',
          (WidgetTester tester) async {
        MockApi mockApi = MockApi();
        SensorDriverAction action = SensorDriverAction(
          id: 1,
  ...
  testWidgets('english displays action details, without sensor and only start time',
          (WidgetTester tester) async {
        MockApi mockApi = MockApi();
        SensorDriverAction action = SensorDriverAction(
          id: 1,

...
void main() {
  ...
  testWidgets('accounts on list, user is staff, deletes after confirm',
        ...
        expect(find.text("Czy na pewno chcesz usunąć konto user1?"), findsOneWidget);
  ...
  testWidgets('english accounts on list, user is staff, deletes after confirm',
        ...
        expect(find.text("Are you sure you want to remove user user1?"), findsOneWidget);
  ...
  testWidgets('english does not delete after api error', (WidgetTester tester) async {
    MockApi mockApi = MockApi();
    List<Map<String, dynamic>> accounts = [
      {
        "id": 1,

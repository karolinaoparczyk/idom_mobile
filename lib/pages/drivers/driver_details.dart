...
class DriverDetails extends StatefulWidget {
  DriverDetails({@required this.storage,
...
class _DriverDetailsState extends State<DriverDetails> {
                ...
                child: Form(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      if (widget.driver.category == "bulb") SizedBox(
                          height: 20),
  ...
  _sendCommandToRemoteControl(String command, {int channel}) async {
    ...
    try {
      switch (command) {
        ...
        case "Right":
          if (widget.testApi != null) {
            result = widget.remoteStatusCode;
          } else {
  ...
  _refreshDriverDetails() async {
    try {
      ...
      if (res['statusCode'] == "200") {
        onRefreshDriverSuccess(res['body']);
      }
  ...
  onRefreshDriverSuccess(String res) {
...
class SliderIndicatorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    canvas.drawCircle(
        Offset(position, size.height / 2), 12, Paint()
      ..color = Colors.black);
  }

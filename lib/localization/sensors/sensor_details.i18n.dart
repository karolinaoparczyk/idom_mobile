...
/// translations for sensor details page in polish and english
extension Localization on String {
  static var _t = Translations("pl_pl") +
      ...
      } +
      {
        ...
        "en_uk":
            "Error getting data from the sensor. Check the server connection and try again.",
      } +
      {
        "pl_pl":
            "Błąd pobierania danych z czujnika. Adres serwera nieprawidłowy.",
        "en_uk":
            "Error getting data from the sensor. The server address is invalid.",
      } +
      {
        "pl_pl":
            "Błąd pobierania danych czujnika. Sprawdź połączenie z serwerem i spróbuj ponownie.",
        "en_uk":
            "Error getting sensor data. Check the server connection and try again.",
      } +
      {
        "pl_pl":
